...
export default function SignInPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      setSuccessMsg("Authentication successful! Redirecting to role-based desk...");

      let targetUrl = "/dashboard/retailer";
      if (identifier.includes("admin") || activeRoleType === "admin" || activeRoleType === "accountant") {
        targetUrl = "/dashboard/company";
      } else if (identifier.includes("distributor") || activeRoleType === "distributor") {
        targetUrl = "/dashboard/distributor";
      } else if (identifier.includes("operator") || activeRoleType === "employee") {
        targetUrl = "/dashboard/operator";
      }
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="max-w-5xl w-full bg-white rounded-3xl shadow-2xl border border-slate-200/80 overflow-hidden grid grid-cols-1 lg:grid-cols-12">
        ...
        <div className="lg:col-span-6 p-6 sm:p-10 lg:p-12 flex flex-col justify-center">
          ...
          {/* Toggle Tab Buttons */}
          <div className="grid grid-cols-2 p-1 bg-slate-100 rounded-2xl mb-8 border border-slate-200">
            <button
              type="button"
          ...
          <div className="mb-6">
            ...
            <p className="text-xs text-slate-500 mt-1">Sign in to your InfuseTax portal to manage tax desks and wallets.</p>
          </div>

          {/* Error / Success Notifications */}
          {errorMsg && (
            <div className="mb-5 p-3.5 bg-rose-50 border border-rose-200 rounded-xl flex items-center space-x-2.5 text-xs text-rose-700">
              <AlertCircle className="w-4 h-4 flex-shrink-0" />
              <span>{errorMsg}</span>
            </div>
          )}
          {successMsg && (
            <div className="mb-5 p-3.5 bg-emerald-50 border border-emerald-200 rounded-xl flex items-center space-x-2.5 text-xs text-emerald-700">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-2.5 text-sm bg-slate-50 border border-slate-300 rounded-xl focus:bg-white focus:outline-none focus:border-blue-600 transition-all font-mono font-bold"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-2.5 text-sm bg-slate-50 border border-slate-300 rounded-xl focus:bg-white focus:outline-none focus:border-blue-600 transition-all"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-11 py-2.5 text-sm bg-slate-50 border border-slate-300 rounded-xl focus:bg-white focus:outline-none focus:border-blue-600 transition-all"
                />
                <button
                  type="button"
          ...
          <div className="mt-8 pt-6 border-t border-slate-100">
            ...
            <div className="flex flex-wrap gap-1.5 justify-center">
              <button
                ...
                className={`px-2.5 py-1 text-[11px] font-semibold rounded-lg transition-colors border ${activeRoleType === "admin" ? "bg-blue-600 text-white border-blue-600" : "bg-slate-100 text-slate-600 hover:bg-blue-50 hover:text-blue-700 border-slate-200"}`}
              >
                Super Admin
              </button>
              <button
                type="button"
                onClick={() => handleDemoFill("accountant")}
                className={`px-2.5 py-1 text-[11px] font-semibold rounded-lg transition-colors border ${activeRoleType === "accountant" ? "bg-blue-600 text-white border-blue-600" : "bg-slate-100 text-slate-600 hover:bg-blue-50 hover:text-blue-700 border-slate-200"}`}
              >
                Accountant
              </button>
              <button
                ...
                className={`px-2.5 py-1 text-[11px] font-semibold rounded-lg transition-colors border ${activeRoleType === "distributor" ? "bg-blue-600 text-white border-blue-600" : "bg-slate-100 text-slate-600 hover:bg-blue-50 hover:text-blue-700 border-slate-200"}`}
              >
                Distributor
              </button>
              <button
                ...
                className={`px-2.5 py-1 text-[11px] font-semibold rounded-lg transition-colors border ${activeRoleType === "retailer" ? "bg-blue-600 text-white border-blue-600" : "bg-slate-100 text-slate-600 hover:bg-blue-50 hover:text-blue-700 border-slate-200"}`}
              >
                Retailer
              </button>
              <button
                ...
                className={`px-2.5 py-1 text-[11px] font-semibold rounded-lg transition-colors border ${activeRoleType === "employee" ? "bg-blue-600 text-white border-blue-600" : "bg-slate-100 text-slate-600 hover:bg-blue-50 hover:text-blue-700 border-slate-200"}`}
              >
                Employee
              </button>
            </div>
